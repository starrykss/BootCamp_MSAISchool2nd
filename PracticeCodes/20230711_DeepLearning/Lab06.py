# Lab 06. PySide 6 실습 : 그룹 상자를 이용한 복잡한 UI 만들기 1

import sys
from PySide6.QtWidgets import QApplication, QWidget, QVBoxLayout, QBoxLayout, QGroupBox, QPushButton, QLineEdit, QLabel, QHBoxLayout
