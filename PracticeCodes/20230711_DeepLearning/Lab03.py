# Lab 03. PySide 6 실습 :  파일 다이얼로그와 메시지 박스
import sys
...
class MainWindow(QWidget) :
    ...
    def show_info_message(self):
        QMessageBox.information(self, "info", "info message", QMessageBox.Ok, QMessageBox.Close)

    def show_warning_message(self):
        QMessageBox.warning(self, "warning", "warning message", QMessageBox.Ok, QMessageBox.Close)

    def show_question_message(self):
        result = QMessageBox.question(self, "question", "question message ?", QMessageBox.Yes | QMessageBox.No)
