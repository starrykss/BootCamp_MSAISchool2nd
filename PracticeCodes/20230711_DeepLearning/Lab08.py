# Lab 08. PySide 6 실습 : 이미지 뷰어 프로그램 만들기

import sys
import os
from PySide6.QtWidgets import QApplication, QMainWindow, QPushButton, QVBoxLayout, QFileDialog, QTreeWidget, QTreeWidgetItem, QListWidget,QLabel, QWidget, QHBoxLayout
...
class ImageViewer(QMainWindow) :
    ...
    def display_image(self, index):
        if 0 <= index < len(self.current_images) :
            ...
            scaled_pixmap = pixmap.scaled(self.image_label.size() * 0.9, QtCore.Qt.AspectRatioMode.KeepAspectRatio)
