## Lab 01. ORB 특징점 검출기와 Brute-Force 매칭 알고리즘 사용 실습
...
# 매칭 결과 그리기
result = cv2.drawMatches(img1, keypoint01, img2, keypoint02, matches[:20], None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
