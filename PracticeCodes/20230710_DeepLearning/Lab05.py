# Lab 05. 파이토치를 사용하여 배깅을 CNN에 적용하는 실습 : CIFAR10 데이터셋 활용 (20230707 실습 이어서 with GPU (Tesla T4))
...
# 배깅 앙상블 모델 정의
"""
BaggingClassifier() => 여러개의 분류기를 앙상블 해서 더 좋은 결과를 얻기 위한 알고리즘
DecisionTreeClassifier() => 결정 나무 트리 알고리즘 (트리 깊이 7로 제한)
"""
